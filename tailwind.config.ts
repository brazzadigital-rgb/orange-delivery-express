  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
       ...
       "cta-glow": {
         "0%, 100%": { 
           boxShadow: "0 0 20px 0 hsl(var(--primary) / 0.4), 0 0 40px -10px hsl(var(--primary) / 0.3)",
           transform: "scale(1)"
         },
         "50%": { 
           boxShadow: "0 0 30px 5px hsl(var(--primary) / 0.5), 0 0 60px -5px hsl(var(--primary) / 0.4)",
      ...
      animation: {
       ...
       "shimmer-btn": "shimmer-btn 2.5s ease-in-out infinite",
      },
      spacing: {
        '18': '4.5rem',
        '22': '5.5rem',
